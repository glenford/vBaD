...
class CruisePipelineBDDSpec extends FeatureSpec with GivenWhenThen with MustMatchers {
  ...
  val data = <Projects>
                 ...
                 <Project name="PipelineB :: Stage1 :: buildAndUnitTest" activity="Sleeping" lastBuildStatus="Success" lastBuildLabel="6" lastBuildTime="2010-08-17T19:03:35" webUrl="http://10.23.30.42:8153/cruise/tab/build/detail/BonusTestTool/6/BuildUnitTest/1/build" />
               </Projects>
